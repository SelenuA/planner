...
public class ScheduleWeeklyAdapter extends RecyclerView.Adapter<ScheduleWeeklyAdapter.ViewHolder> {
    private List<ScdlData> localDataSet;
    private Activity context;
    private RoomDB database;

    public ScheduleWeeklyAdapter(Activity context, List<ScdlData> dataSet) {
    ...
    @Override
    public ScheduleWeeklyAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_schedule_list, viewGroup, false);
        return new ScheduleWeeklyAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ScheduleWeeklyAdapter.ViewHolder viewHolder, final int position) {
