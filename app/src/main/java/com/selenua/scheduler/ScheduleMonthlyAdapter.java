...
public class ScheduleMonthlyAdapter extends RecyclerView.Adapter<ScheduleMonthlyAdapter.ViewHolder> {
    private List<ScdlData> localDataSet;
    private Activity context;
    private RoomDB database;
    private Calendar cal;

    public ScheduleMonthlyAdapter(Activity context, List<ScdlData> dataSet) {
    ...
    @Override
    public ScheduleMonthlyAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_schedule_list, viewGroup, false);
        return new ScheduleMonthlyAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ScheduleMonthlyAdapter.ViewHolder viewHolder, final int position) {
